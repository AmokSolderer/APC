...
Note that if you're machine is using vocals as part of the music then these have to be mixed into the music. The reason for this is explained [here](https://github.com/AmokSolderer/APC/blob/master/DOC/PinMameSound_11.md#special-cases).
