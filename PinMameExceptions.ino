...
byte EX_Rollergames(byte Type, byte Command){
	...
	case SoundCommandCh1:																// sound commands for channel 1
		if (!Command){ 																		// sound command 0x00 - stop sound
			...
			PlayMusic(50, "0_01.snd");											// play non looping part of music track 1
			const char FileName[] = "0_01L.snd";						// generate filename for looping part of music track 1
			...
			PlayMusic(50, "0_03.snd");											// play non looping part of music track
			const char FileName[] = "0_03L.snd";						// generate filename for looping part of music track
			NextMusicName = (char*) FileName;								// let NextSoundName point to filename of looping part
			AfterMusic = PlayNextMusic;}										// will loop NextMusicName
		else if (Command == 6) {													// music track 6 Multiball start
			PlayMusic(50, "0_06.snd");											// play non looping part of music track
			const char FileName[] = "0_06L.snd";						// generate filename for looping part of music track
			NextMusicName = (char*) FileName;								// let NextSoundName point to filename of looping part
			AfterMusic = PlayNextMusic;}										// will loop NextMusicName
		else if (Command == 8) {													// music track 8 Multiball lock
			PlayMusic(50, "0_08.snd");											// play non looping part of music track
			const char FileName[] = "0_08L.snd";						// generate filename for looping part of music track
			NextMusicName = (char*) FileName;								// let NextSoundName point to filename of looping part
			AfterMusic = PlayNextMusic;}										// will loop NextMusicName
		else if (Command == 9 || Command == 66) {					// music track 9 identical to 0x42
			PlayMusic(50, "0_09.snd");											// play non looping part of music track
			const char FileName[] = "0_09L.snd";						// generate filename for looping part of music track
			NextMusicName = (char*) FileName;								// let NextSoundName point to filename of looping part
			AfterMusic = PlayNextMusic;}										// will loop NextMusicName
		else if (Command == 13) {													// music track 0x0d
			PlayMusic(50, "0_0d.snd");											// play non looping part of music track
			const char FileName[] = "0_0dL.snd";						// generate filename for looping part of music track
			NextMusicName = (char*) FileName;								// let NextSoundName point to filename of looping part
			AfterMusic = PlayNextMusic;}										// will loop NextMusicName
		else if (Command == 67) {													// music track 0x43
			PlayMusic(50, "0_43.snd");											// play non looping part of music track
			const char FileName[] = "0_43L.snd";						// generate filename for looping part of music track
			NextMusicName = (char*) FileName;								// let NextSoundName point to filename of looping part
			AfterMusic = PlayNextMusic;}										// will loop NextMusicName
		else if (Command == 68) {													// music track 0x44
			PlayMusic(50, "0_44.snd");											// play non looping part of music track
			const char FileName[] = "0_43L.snd";						// generate filename for looping part of music track
			NextMusicName = (char*) FileName;								// let NextSoundName point to filename of looping part
			AfterMusic = PlayNextMusic;}										// will loop NextMusicName
		else {																						// standard sound
