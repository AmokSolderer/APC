...
const unsigned int BC_SolTimes[32] = {30,30,50,50,50,50,30,50,50,0,0,0,50,50,50,50,50,50,50,50,50,50,0,0,100,100,100,100,100,100,100,100}; // Activation times for solenoids
...
struct SettingTopic BC_setList[5] = {{"  GOD   MODE  ",HandleBoolSetting,0,0,0}, // defines the game specific settings
